...
def test(model, device, test_loader, epsilon):
    ...
    return final_acc, final_success, adv_examples
...
for eps in epsilons:
    ...
    acc, suc, ex = test(resnet, device, loader, eps)
...
plt.xticks(epsilons)
plt.title("Perturbation FGSM avec cible \"mountain\"")
plt.xlabel("Epsilon")
plt.ylabel("Accuracy")
plt.show()
